...
class AddServiceTimesForm : AbstractOsmQuestForm<CollectionTimesAnswer>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val oh = element.tags["service_times"]?.toOpeningHoursOrNull(lenient = true)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.composeViewBase.content { Surface {
            OpeningHoursTable(
                ...
                addButtonContent = { Text(stringResource(Res.string.quest_openingHours_add_time)) },
