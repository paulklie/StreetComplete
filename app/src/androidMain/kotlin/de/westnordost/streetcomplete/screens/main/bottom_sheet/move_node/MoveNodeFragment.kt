...
class MoveNodeFragment :
    ...
    private val backgroundText = mutableStateOf("")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.composeView.content {
            MoveNodeForm(
                ...
                onClickBackground = { toggleBackground() },
        ...
        binding.okButtonComposeView.content {
            FloatingOkButton(
                visible = distance.floatValue.toDouble() in minMoveDistance..MAX_MOVE_DISTANCE,
                onClick = { onClickOk() },
    ...
    private fun updateMapButtonText() {
        ...
        backgroundText.value = context?.getString(textId) ?: ""
    }
